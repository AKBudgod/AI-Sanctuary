// Tier System for AI Sanctuary
// Designed for full transparency in AI research
...
export const TIERS: Record<UserTier, TierBenefits> = {
  ...
  developer: {
    name: 'Developer Mode',
    description: 'Paid access. Options: $20/mo, $50/yr, or $100 Lifetime.',
    minHours: 0,
    ...
    features: ['Instant Unlock', '100,000 SANC Tokens Included', 'Priority Support', 'No Safety Filters (Uncensored)'],
