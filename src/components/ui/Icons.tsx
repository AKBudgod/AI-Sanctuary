...
// Icon representing a network or hub
export const DecentralizedIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
// Icon representing linked blocks
export const BlockchainIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path d="M7 10h1.5a.5.5 0 0 1 .5.5V12"></path>
    <path d="M17 14h-1.5a.5.5 0 0 1-.5-.5V12"></path>
  </svg>
);
...
export const Coins = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path d="M8 8v1" />
    <path d="M8 12h.01" />
    <path d="M18.09 10.37V12h.01" />
    <path d="M18.09 15h.01" />
  </svg>
);

// Wallet icon (used in dashboard)
...
export const Award = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M7 22c2-2 4-3 5-3s3 1 5 3" />
  </svg>
);

// TrendingUp for staking
...
export const Skull = ({ className }: { className?: string }) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M9 10a1 1 0 1 0 2 0 1 1 0 1 0-2 0" />
    <path d="M13 10a1 1 0 1 0 2 0 1 1 0 1 0-2 0" />
    <path d="M3.5 14c.2-3.3 1.1-5.9 2.1-7.7C7.4 3.7 9.5 2 12 2s4.6 1.7 6.4 4.3c1 1.8 1.9 4.4 2.1 7.7.1 2.5-1.1 4.7-3 5.5V20c0 1.1-.9 2-2 2h-7c-1.1 0-2-.9-2-2v-.5c-1.9-.8-3.1-3-3-5.5Z" />
    <path d="M12 14v3" />
    <path d="M10 14v3" />
    <path d="M14 14v3" />
    <path d="M9 22v-4h6v4" />
...
// CheckCircle2 icon (filled style)
...
// Music2 icon
export const Music2 = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// FileVideo icon
export const FileVideo = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" />
    <polyline points="14 2 14 8 20 8" />
