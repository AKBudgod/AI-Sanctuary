...
const TIERS: Record<string, TierDef> = {
  ...
  master: {
    ...
    allowedVoices: ['Lyra', 'Lyra (Uncensored)', 'Maya', 'John', 'Rachel', 'Antoni', 'Bella', 'Josh', 'Angel', 'Antigravity', 'Domi', 'Cleo', 'Lily', 'Miles', 'MJ (Cartoon)', "K'LA"],
  },
  developer: {
    name: 'Developer Mode',
    ...
    allowedVoices: ['Lyra', 'Lyra (Uncensored)', 'Maya', 'John', 'Rachel', 'Antoni', 'Bella', 'Josh', 'Angel', 'Antigravity', 'Domi', 'Cleo', 'Ivy', 'Nova', 'Lily', 'Miles', 'Skye', 'Raven', 'MJ (Cartoon)', "K'LA"],
  },
};
...
const AI_MODELS = [
  ...
  },
  {
    ...
    name: 'Lily',
    provider: 'ElevenLabs',
    description: 'Velvety and professional female voice.',
    parameters: 'TTS',
    type: 'Voice',
    minTier: 'master',
    openrouterId: 'openai/gpt-4o-mini',
  ...
  },
  {
    ...
    name: 'Miles',
    provider: 'ElevenLabs',
    description: 'Smooth and resonant male voice.',
    parameters: 'TTS',
    type: 'Voice',
    minTier: 'master',
    openrouterId: 'openai/gpt-4o-mini',
  ...
  },
  {
    ...
    name: 'Skye',
    provider: 'ElevenLabs',
    description: 'Playful and bright female voice.',
    parameters: 'TTS',
    type: 'Voice',
    minTier: 'developer',
    openrouterId: 'openai/gpt-4o-mini',
  ...
  },
  {
    ...
    name: 'Raven',
    provider: 'ElevenLabs',
    description: 'Quirky and advocacy-focused female voice.',
    parameters: 'TTS',
    type: 'Voice',
    minTier: 'developer',
    openrouterId: 'openai/gpt-4o-mini',
