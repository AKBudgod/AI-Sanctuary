...
import { onRequestOptions as __api_models_ts_onRequestOptions } from "C:\\Users\\Weed j\\Downloads\\ai-sanctuary-website\\functions\\api\\models.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "OPTIONS",
      middlewares: [],
      modules: [__api_models_ts_onRequestOptions],
    },
  {
      routePath: "/api/models",
      mountPath: "/api",
