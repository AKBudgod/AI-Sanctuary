...
// .wrangler/tmp/pages-mM7xvK/functionsWorker-0.5517463022689771.mjs
...
var onRequestPost5 = /* @__PURE__ */ __name2(async (context2) => {
  if (!isAuthorized(context2.request, context2.env)) {
    return new Response(
      JSON.stringify({ error: "Unauthorized - Provide API key in Authorization header" }),
      { status: 401, headers: { "Content-Type": "application/json" } }
...
var onRequestGet6 = /* @__PURE__ */ __name2(async (context2) => {
  const env22 = context2.env;
  try {
    const authHeader = context2.request.headers.get("Authorization");
...
async function callAIProvider(env22, modelId, prompt, parameters, currentTier, agentEntry, history = []) {
...
async function onRequestGet7({ request, env: env22 }) {
  const authHeader = request.headers.get("Authorization");
...
async function onRequestPost8({ request, env: env22 }) {
  try {
    ...
    if (modelId.startsWith("agent_")) {
      ...
      const rawAgent = env22.USERS_KV ? await env22.USERS_KV.get(dbId) : null;
      if (!rawAgent) {
    ...
    const result = await callAIProvider(env22, modelId, prompt, parameters, currentTier, agentEntry, history);
    return new Response(JSON.stringify({
...
var onRequestPost11 = /* @__PURE__ */ __name2(async (context2) => {
  try {
...
var onRequestPost12 = /* @__PURE__ */ __name2(async (context2) => {
  try {
...
var onRequestPost13 = /* @__PURE__ */ __name2(async (context2) => {
  try {
...
var onRequestGet10 = /* @__PURE__ */ __name2(async (context2) => {
  try {
    const url = new URL(context2.request.url);
    const address = url.searchParams.get("address");
    if (!address) {
...
// .wrangler/tmp/bundle-tfoxdw/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-tfoxdw/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5517463022689771.js.map
