...
// .wrangler/tmp/pages-De5M6d/functionsWorker-0.9182929723016852.mjs
...
function getStore3(env22, bindingName) {
  if (env22[bindingName]) return env22[bindingName];
  return {
...
async function onRequestGet5({ request, env: env22 }) {
  const authHeader = request.headers.get("Authorization");
...
// .wrangler/tmp/bundle-3BdI55/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3BdI55/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9182929723016852.js.map
